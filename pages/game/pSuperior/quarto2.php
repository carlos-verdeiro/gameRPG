...
if (isset($_SESSION["status"]) && $_SESSION["status"] == "iniciado") {
    ...
    $_SESSION['localAtual'] = 'pSuperior/quarto2';
...
<head>
    ...
    <title>A Busca pelo Graal - Quarto 2</title>
</head>

<body>
    <main class="telaPrincipal" id="quarto2">
        <section id="section1">
            <div id="inventario">
                <?php $pathImagens = '../../../';
                ...
                <content>
                    ...
                    if ($respondido) {
                        if ($_POST['resposta'] == $correta) {
                            echo '<h1>Livro</h1>';
                            echo '<p>Deseja largar o livro?</p>';
